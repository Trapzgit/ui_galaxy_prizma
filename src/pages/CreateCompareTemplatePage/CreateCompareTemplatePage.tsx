        ...
        <div className="template-page">
            <div className="template-breadcrumbs">
                <button
                    ...
                    aria-label="Вернуться к сервису"
                >
                ...
                <span className="template-breadcrumbs__text">ОТТ Платформы Экосистемы 4G</span>

                <span className="template-breadcrumbs__separator" aria-hidden="true">
